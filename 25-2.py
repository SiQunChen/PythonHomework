...
def not_same_suit(card):
    ...
    if end==0:
        ...
        if a.get(j)==4 or a.get(k)==4:
            ...
            print("6")
        elif a.get(j)==3 or a.get(k)==3 or a.get(l)==3:
            print("3")
        elif (a.get(j)==2 and a.get(k)==2) or (a.get(j)==2 and a.get(l)==2) or (a.get(k)==2 and a.get(l)==2):
            print("2")
        elif a.get(j)==2 or a.get(k)==2 or a.get(l)==2 or a.get(m)==2:
            print("1")
        else:
            print("0")
